...
def resNet18(shared_isStart, shared_powerDraw_1epoch, shared_fepochd, shared_fepochPer, shared_fepochPow, shared_epoch,
    ...
    sumPowerDraw = 0
    sumPerformance = 0
    shared_epoch.value = epochs  # 서버로 보낼 에폭
...
if __name__ == "__main__":
    ...
    profiler_process3 = multiprocessing.Process(target=resNet18, args=(
